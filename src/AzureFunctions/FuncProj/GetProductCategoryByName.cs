...
namespace FuncProj
{
    public class GetProductCategoryByName
    {
        private readonly ILogger _logger;
        private readonly AdventureWorksContext _context;

        public GetProductCategoryByName(ILoggerFactory loggerFactory, AdventureWorksContext context)
        {
            _logger = loggerFactory.CreateLogger<GetProductCategoryByName>();
            _context = context;
        }

        [Function("GetProductCategoryByName")]
        public HttpResponseData Run([HttpTrigger(AuthorizationLevel.Function, "get", Route = "ProductCategory/{category:alpha?}")] HttpRequestData req, string category)
        {
